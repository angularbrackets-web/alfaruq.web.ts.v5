    ...
    <nav className="bg-gray-800 sticky top-0 z-30">
      ...
      <div ref={mobileMenuRef} className="mobile-menu hidden" onMouseLeave={mobileMenuButtonClick} >
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <Link href="#PrayerTimes" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
            
              Prayer Times
            
          </Link>
          <Link href="#Programs" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
